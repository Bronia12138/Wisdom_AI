...
@Configuration
@ConditionalOnProperty(prefix = "zk.swagger", name = "enable", havingValue = "true")
...
public class Knife4jConfiguration {
    ...
    @Bean
    @ConditionalOnProperty(name = "zk.swagger.enable", havingValue = "true")
    ...
    // @Bean
    // @Primary
    // @ConditionalOnProperty(prefix = "zk.swagger", name = "enableResponseWrap",havingValue = "true")
    ...
    //     converterRegistry.putCustom(LocalDateTime.class, new zkTemporalConverter(LocalDateTime.class));
    // }
