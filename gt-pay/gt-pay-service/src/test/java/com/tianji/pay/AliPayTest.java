...
public class AliPayTest {
    ...
    private static Config getOptions() {
        ...
        config.appId = System.getenv("GT_PAY_ALI_APP_ID");
        // 为避免私钥随源码泄露，推荐从文件中读取私钥字符串而不是写入源码中
        config.merchantPrivateKey = System.getenv("GT_PAY_ALI_MERCHANT_PRIVATE_KEY");
        config.alipayPublicKey = System.getenv("GT_PAY_ALI_PUBLIC_KEY");
        //可设置异步通知接收服务地址（可选）
        config.notifyUrl = System.getenv("GT_PAY_ALI_NOTIFY_URL");
        return config;
    }
}
