...
@Configuration
@ConditionalOnProperty(prefix = "gt.swagger", name = "enable", havingValue = "true")
...
public class Knife4jConfiguration {
    ...
    @Bean
    @ConditionalOnProperty(name = "gt.swagger.enable", havingValue = "true")
    ...
    // @Bean
    // @Primary
    // @ConditionalOnProperty(prefix = "gt.swagger", name = "enableResponseWrap",havingValue = "true")
    ...
    //     converterRegistry.putCustom(LocalDateTime.class, new GtTemporalConverter(LocalDateTime.class));
    // }
